                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            ...
                            <a class="btn btn-primary  btn-sm" href="{{ route('admin.child-category.create') }}"><i
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu animated--fade-in"
                                                        ...
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.child-category.change.status', ['id' => $category->id]) }}">Enable</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.child-category.change.status', ['id' => $category->id]) }}">Disable</a>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="action-list">
                                                    <a class="btn btn-secondary btn-sm "
                                                        href="{{ route('admin.child-category.edit', ['id' => $category->id]) }}">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <a class="btn btn-danger btn-sm " data-toggle="modal"
                                                        data-target="#confirm-delete" href="javascript:;"
                                                        data-href="{{ route('admin.child-category.delete', ['id' => $category->id]) }}">
