                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            ...
                            <a class="btn btn-primary  btn-sm" href="{{ route('admin.faq-category.create') }}"><i
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu animated--fade-in"
                                                        ...
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.faq-category.change.status', ['id' => $category->id]) }}">Enable</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.faq-category.change.status', ['id' => $category->id]) }}">Disable</a>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
